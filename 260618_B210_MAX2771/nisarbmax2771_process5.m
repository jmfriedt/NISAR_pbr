%octave:3> load kpos_max2771.mat 
% octave:4> k=find(kpos>12*24e6);k=k(1)
% k = 9144
% octave:5> k=find(kpos>14*24e6);k=k(1)
% k = 12962

%octave:7> k=find(kpos>13*24e6);k=k(1)
%k = 11053
%octave:8> k=find(kpos>15*24e6);k=k(1)
%k = 14872
...
%% Raw data
 ...
 % pindx=kpos(9101:9101+P+L);
 pindx=kpos(11501:11501+P+L);
