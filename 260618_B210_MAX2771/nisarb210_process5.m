%octave:1> load kpos_b210.mat 
%octave:2> k=find(kpos>5*22e6);k=k(1)
%k = 3534
%octave:3> k=find(kpos>6*22e6);k=k(1)
%k = 5443
...
%% Load data
f1=fopen('ref_b210.bin');  % 2=ref
f2=fopen('sur_b210.bin');  % 1=sur
clear d
...
colormap(jet);colorbar;clim([-52,0]);
...
clim([-52,0]);colormap(jet);colorbar;
