% octave:8> k=find(kpos>3.5*22e6);k=k(1)
% k = 4248
% octave:9> k=find(kpos>5*22e6);k=k(1)
% k = 7113
...
%% Load data
f1=fopen('b210_ref.bin');  % 2=ref
f2=fopen('b210_sur.bin');  % 1=sur
...
beta_I = linspace(0,10000,2501);nbe = length(beta_I);
...
xm = linspace(-5000,5.5e3,3801);nxm = length(xm);
